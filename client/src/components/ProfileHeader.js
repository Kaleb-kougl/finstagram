    ...
    render() {
        return (
            <div className="profile-header">
                ...
                <p className="profile-counts">{this.state.postCount} Posts</p>
                <p className="profile-counts">{this.state.followersCount} Followers</p>
                <p className="profile-counts">{this.state.profileCounts} Following</p>
